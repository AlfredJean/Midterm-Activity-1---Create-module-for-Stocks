<template>
  <div class="flex">
    <div
      class="flex flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600"
    >
      ...
      <div class="flex flex-col items-center mt-6 -mx-2">
        <img
          ...
          src="https://lh3.googleusercontent.com/-5-ewjDiWr0k/X2A7ojc_gxI/AAAAAAAAAFM/ymbz9Pm_vooRdcp_90ccfuoyu-Vaz5_kwCEwYBhgLKtQDAL1OcqwYSbLMmQBE_k3nonGY6JFXBr3tlauAfei3QivTS6Ws5i6eiRWyE2cv5Bj2ZwU1_H7gwKYEwoqad3AN5-NIfnJyhwBq5rGhcK0qWe1ThVAQDtdKgCFJbZ3-5QOXNH6KyWx1vSf40gO7lUwHdI4LgrBB2RUD4flnwQK-Vcx8HSaz9PDHlHLBw6fAU_d-1k-o46vfysF25vRUK1QqSZaH7KNM-VjxPJwAafPHmRnk5_5wFpYR3nMmJ_ZZosIY5g3f2bAQGOTBVoHRltFb837zt9HXxEXdflQhLGu21xEvzFA9HF_L0OAmbW0-eUKh9_k2vHr60pF2MetBoizEtpJHe35I0vBBsbvHs0TW6LiH2CmTjRXA6Tjzv8onFAA_AAdlRhka729mZrcCQElC3PG4I7woyfR4UR5okWFni-JrTyqE6W_AZhr2Om3cEbV7UxwO0I1QG4AjzCJ9kMdH35YGyDFzj2NmN42rL3BmQDSwblWht3gLhVsLOad-RQjPjfMzUYJF8CDAGpLxiP0OKrVg2PyCBt_A9rvTa2NsL-IF6iZlVxmWsQByOeDRMq587jpO3QIlQNWrUSTa9lqoIjRiw5zixbdZWehPpIEL8FWYy6LWMMq_-IIG/w139-h140-p/119175260_322895415657702_7588706887932706270_n.jpg"
          alt="avatar"
        />
        <h4
            ...
            >
              <div class="px-4 py-2">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                  Our lightest PRO mouse yet, PRO X SUPERLIGHT is an engineering
                  breakthrough achieving a weight of less than 63 grams—nearly
                  25% lighter than our standard PRO Wireless mouse. This was
                  accomplished through meticulous engineering to produce extreme
                  weight reduction with zero compromises to performance.
                </p>
              </div>

              <img
                class="object-cover w-full h-48 mt-2"
                src="https://vamers-com.exactdn.com/wp-content/uploads/2018/08/Vamers-Technology-Logitech-launches-G-Pro-Wireless-Mouse-02.jpg"
                alt="Logitech G Pro X Wireless Gaming Mouse"
              />

              <div
                class="flex items-center justify-between px-4 py-2 bg-gray-900"
              >
                <h1 class="text-lg font-bold text-white">$150</h1>
                <button
